(function($) {
	...
	if($('.filter-gallery-one .filter-gallery').length){
		
		$(".filter-gallery-one .filter-gallery").mixItUp({
			selectors: {
	...
	if($('.filter-gallery-two .filter-gallery').length){
		
		$(".filter-gallery-two .filter-gallery").mixItUp({
			selectors: {
			  target: ".mix" // As in mixitup
			},
			layout: {
